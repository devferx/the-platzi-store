export const SkeletonCard = () => {
  return (
    <div
      role="status"
      className="max-w-sm animate-pulse rounded-lg border border-gray-200 p-4 shadow md:p-6 dark:border-gray-700"
    >
      ...
      <div className="mt-4 flex items-center justify-between gap-2">
        <div className="mb-2 h-6 w-32 rounded-full bg-gray-200 dark:bg-gray-700" />
